...
public class DestructibleTrunk : MonoBehaviour, IDestructible
{
    ...
    private MeshCollider edge_MeshCollider;
    ...
    public void Initialize()
    {
        ...
        faceVisual.transform.eulerAngles = new Vector3(90, 0, 0);
        ...
        meshFilter = faceVisual.AddComponent<MeshFilter>();
        meshFilter.mesh = faceMesh;

        meshRenderer = faceVisual.AddComponent<MeshRenderer>();
        ...
        edgeVisual.transform.eulerAngles = new Vector3(90, 0, 0);
        edgeVisual.name = "EdgeVisual";
        edgeVisual.tag = "Ground";

        if (!isUnderGround)
            edge_MeshCollider = edgeVisual.gameObject.AddComponent<MeshCollider>();
    ...
    {
        if (!isUnderGround)
            edge_MeshCollider.sharedMesh = edgeMesh;
    }
